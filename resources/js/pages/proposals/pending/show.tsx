...
import { Download, FileText, ChevronLeft, CheckCircle, XCircle } from 'lucide-react';
...
export default function ShowPendingProposal({ auth, proposal }: Props) {
    ...
    const handleApprove = () => {
        ...
        router.post(route('proposals.manage.approve', proposal.id), {}, {
            ...
            onSuccess: () => {
                ...
                router.visit(route('proposals.pending'));
            },
            onError: () => {
                setIsSubmitting(false);
    ...
    return (
        <AppLayout user={auth.user} breadcrumbs={breadcrumbs}>
            <Head title={`Pending Proposal: ${proposal.title}`} />
                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6">
                            <div className="flex justify-between items-center mb-6">
                                ...
                                <Link href={route('proposals.pending')}>
